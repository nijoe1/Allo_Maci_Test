...
/**
   ...
   * @license MIT
   * @see [Github]{@link https://github.com/privacy-scaling-explorations/zk-kit/tree/main/packages/utils}
  */function gt(t,r){if(!at(t))throw new TypeError(`Parameter '${r}' is not a bignumber-ish`)}function pt(t,r,e){for(const t of e)if(!lt(t))throw new Error(`Type '${t}' is not supported`);for(const r of e)if(ct(t,r))return;throw new TypeError(`Parameter '${r}' is none of the following types: ${e.join(", ")}`)}
/**
   * @module @zk-kit/utils
   * @version 0.8.1
   * @file Essential zero-knowledge utility library for JavaScript developers.
   ...
   * @license MIT
   * @see [Github]{@link https://github.com/privacy-scaling-explorations/zk-kit/tree/main/packages/utils}
  */function yt(t){!function(t,r){if(!ut(t))throw new TypeError(`Parameter '${r}' is not a bigint, received type: ${typeof t}`)}(t,"value");let r=t.toString(16);return r.length%2!=0&&(r=`0${r}`),r}function dt(t){return pt(t,"value",["Buffer","Uint8Array"]),BigInt(`0x${y.from(t).reverse().toString("hex")}`)}function wt(t){return function(t){return pt(t,"value",["Buffer","Uint8Array"]),BigInt(`0x${y.from(t).toString("hex")}`)}(t)}function Et(t,r){const e=yt(t),n=Math.ceil(e.length/2);if(r){if(r<n)throw Error(`Size ${r} is too small, need at least ${n} bytes`)}else r=n;const i=y.alloc(r,0);return y.from(e,"hex").reverse().copy(i,0),i}function At(t){return gt(t,"value"),ot(t)||it(t)?wt(t):BigInt(t)}
/**
   * @module @zk-kit/utils
   * @version 0.8.1
   * @file Essential zero-knowledge utility library for JavaScript developers.
