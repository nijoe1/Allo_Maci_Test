...
*/
import { mulPointEscalar, Base8, subOrder, inCurve, addPoint, Fr, packPoint, unpackPoint } from '@zk-kit/baby-jubjub';
import { requireBuffer, crypto } from '@zk-kit/utils';
import { bigNumberishToBigInt, bufferToBigInt, leBufferToBigInt, leBigIntToBuffer, bufferToHexadecimal } from '@zk-kit/utils/conversions';
...
function deriveSecretScalar(privateKey) {
    ...
    return scalar.shiftRight(leBufferToBigInt(hash$1), BigInt(3));
}
/**
...
class EdDSAPoseidon {
     ...
     */
    constructor(privateKey = bufferToHexadecimal(crypto.getRandomValues(32))) {
