...
async function cli() {
    ...
    const circomkit = new circomkit_1.Circomkit((0, fs_1.existsSync)(CONFIG_PATH) ? JSON.parse((0, fs_1.readFileSync)(CONFIG_PATH, 'utf-8')) : {});
    // smol utility function to print pretty titles in the same format
    const titleLog = (title) => circomkit.log(`===| ${title} |===`, 'title');
    // execute command
    ...
    switch (command) {
        ...
        case 'json': {
            ...
            const { json, path } = await circomkit.json(process.argv[3], process.argv[4], process.argv[5]);
            (0, fs_1.writeFileSync)(path, (0, utils_1.prettyStringify)(json));
        ...
        case 'help':
            ...
            console.log(utils_1.usageString);
            break;
        default:
