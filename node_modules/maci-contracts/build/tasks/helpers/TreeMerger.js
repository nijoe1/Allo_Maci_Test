...
class TreeMerger {
     ...
     */
    constructor({ deployer, signupAccQueueContract, messageAccQueueContract, pollContract, maciContract, }) {
     ...
     */
    async mergeSignupSubtrees(pollId, queueOps) {
