...
export interface MACIInterface extends Interface {
    getFunction(nameOrSignature: "MESSAGE_DATA_LENGTH" | "deployPoll" | "getPoll" | "getStateAqRoot" | "hash2" | "hash3" | "hash4" | "hash5" | "hashLeftRight" | "hashMessageAndEncPubKey" | "hashStateLeaf" | "initialVoiceCreditProxy" | "mergeStateAq" | "mergeStateAqSubRoots" | "messageProcessorFactory" | "nextPollId" | "numSignUps" | "owner" | "padAndHashMessage" | "pollFactory" | "polls" | "renounceOwnership" | "sha256Hash" | "signUp" | "signUpGatekeeper" | "stateAq" | "stateTreeDepth" | "subtreesMerged" | "tallyFactory" | "topupCredit" | "transferOwnership"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "DeployPoll" | "OwnershipTransferred" | "SignUp"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "getStateAqRoot", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "mergeStateAq", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mergeStateAqSubRoots", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "topupCredit", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getStateAqRoot", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "mergeStateAq", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mergeStateAqSubRoots", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "topupCredit", data: BytesLike): Result;
...
export interface MACI extends BaseContract {
    ...
    getFunction(nameOrSignature: "getPoll"): TypedContractMethod<[_pollId: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "getStateAqRoot"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "mergeStateAq"): TypedContractMethod<[_pollId: BigNumberish], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "mergeStateAqSubRoots"): TypedContractMethod<[
        _numSrQueueOps: BigNumberish,
        _pollId: BigNumberish
    ], [
        void
    ...
    getFunction(nameOrSignature: "polls"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "stateAq"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "topupCredit"): TypedContractMethod<[], [string], "view">;
    ...
    filters: {
        "DeployPoll(uint256,uint256,uint256,tuple)": TypedContractEvent<DeployPollEvent.InputTuple, DeployPollEvent.OutputTuple, DeployPollEvent.OutputObject>;
