...
export declare namespace DomainObjs {
    ...
    type MessageStructOutput = [msgType: bigint, data: bigint[]] & {
        msgType: bigint;
        data: bigint[];
    };
...
export interface PollInterface extends Interface {
    getFunction(nameOrSignature: "MESSAGE_DATA_LENGTH" | "coordinatorPubKey" | "coordinatorPubKeyHash" | "currentSbCommitment" | "extContracts" | "getDeployTimeAndDuration" | "hash2" | "hash3" | "hash4" | "hash5" | "hashLeftRight" | "hashMessageAndEncPubKey" | "hashStateLeaf" | "init" | "maxValues" | "mergeMaciStateAq" | "mergeMaciStateAqSubRoots" | "mergeMessageAq" | "mergeMessageAqSubRoots" | "mergedStateRoot" | "numMessages" | "numSignUpsAndMessages" | "numSignups" | "owner" | "padAndHashMessage" | "publishMessage" | "publishMessageBatch" | "renounceOwnership" | "sha256Hash" | "stateAqMerged" | "topup" | "transferOwnership" | "treeDepths"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "MergeMaciStateAq" | "MergeMaciStateAqSubRoots" | "MergeMessageAq" | "MergeMessageAqSubRoots" | "OwnershipTransferred" | "PublishMessage" | "TopupMessage"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "mergeMaciStateAq", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mergeMaciStateAqSubRoots", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "padAndHashMessage", values: [[BigNumberish, BigNumberish], BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "stateAqMerged", values?: undefined): string;
    encodeFunctionData(functionFragment: "topup", values: [BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "mergeMaciStateAq", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mergeMaciStateAqSubRoots", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "stateAqMerged", data: BytesLike): Result;
...
export declare namespace MergeMaciStateAqEvent {
    type InputTuple = [
...
export declare namespace MergeMaciStateAqSubRootsEvent {
...
export declare namespace TopupMessageEvent {
    type InputTuple = [_message: DomainObjs.MessageStruct];
    type OutputTuple = [_message: DomainObjs.MessageStructOutput];
    interface OutputObject {
        _message: DomainObjs.MessageStructOutput;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface Poll extends BaseContract {
    ...
    getFunction(nameOrSignature: "maxValues"): TypedContractMethod<[
    ], [
        [bigint, bigint] & {
            maxMessages: bigint;
            maxVoteOptions: bigint;
    ...
    getFunction(nameOrSignature: "mergeMaciStateAq"): TypedContractMethod<[_pollId: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "mergeMaciStateAqSubRoots"): TypedContractMethod<[
        _numSrQueueOps: BigNumberish,
        _pollId: BigNumberish
    ], [
        void
    ...
    getFunction(nameOrSignature: "stateAqMerged"): TypedContractMethod<[], [boolean], "view">;
    ...
    getEvent(key: "MergeMaciStateAq"): TypedContractEvent<MergeMaciStateAqEvent.InputTuple, MergeMaciStateAqEvent.OutputTuple, MergeMaciStateAqEvent.OutputObject>;
    getEvent(key: "MergeMaciStateAqSubRoots"): TypedContractEvent<MergeMaciStateAqSubRootsEvent.InputTuple, MergeMaciStateAqSubRootsEvent.OutputTuple, MergeMaciStateAqSubRootsEvent.OutputObject>;
    ...
    getEvent(key: "TopupMessage"): TypedContractEvent<TopupMessageEvent.InputTuple, TopupMessageEvent.OutputTuple, TopupMessageEvent.OutputObject>;
    filters: {
        "MergeMaciStateAq(uint256,uint256)": TypedContractEvent<MergeMaciStateAqEvent.InputTuple, MergeMaciStateAqEvent.OutputTuple, MergeMaciStateAqEvent.OutputObject>;
        MergeMaciStateAq: TypedContractEvent<MergeMaciStateAqEvent.InputTuple, MergeMaciStateAqEvent.OutputTuple, MergeMaciStateAqEvent.OutputObject>;
        "MergeMaciStateAqSubRoots(uint256)": TypedContractEvent<MergeMaciStateAqSubRootsEvent.InputTuple, MergeMaciStateAqSubRootsEvent.OutputTuple, MergeMaciStateAqSubRootsEvent.OutputObject>;
        MergeMaciStateAqSubRoots: TypedContractEvent<MergeMaciStateAqSubRootsEvent.InputTuple, MergeMaciStateAqSubRootsEvent.OutputTuple, MergeMaciStateAqSubRootsEvent.OutputObject>;
        ...
        "TopupMessage(tuple)": TypedContractEvent<TopupMessageEvent.InputTuple, TopupMessageEvent.OutputTuple, TopupMessageEvent.OutputObject>;
        TopupMessage: TypedContractEvent<TopupMessageEvent.InputTuple, TopupMessageEvent.OutputTuple, TopupMessageEvent.OutputObject>;
    };
}
