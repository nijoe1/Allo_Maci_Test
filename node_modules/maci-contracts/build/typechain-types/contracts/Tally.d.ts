...
export interface TallyInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "verifyTallyProof", values: [
        BigNumberish[],
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "genTallyVotesPackedVals", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "genTallyVotesPublicInputHash", data: BytesLike): Result;
...
export interface Tally extends BaseContract {
    ...
    getFunction(nameOrSignature: "genTallyVotesPackedVals"): TypedContractMethod<[
        _numSignUps: BigNumberish,
        _batchStartIndex: BigNumberish,
        _tallyBatchSize: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "genTallyVotesPublicInputHash"): TypedContractMethod<[
        _numSignUps: BigNumberish,
        _batchStartIndex: BigNumberish,
        _tallyBatchSize: BigNumberish,
        _newTallyCommitment: BigNumberish
