...
export interface HasherBenchmarksInterface extends Interface {
    getFunction(nameOrSignature: "hash2" | "hash3" | "hash4" | "hash5" | "hash5Benchmark" | "hashLeftRight" | "hashLeftRightBenchmark" | "sha256Hash"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "hash5Benchmark", values: [
        [
            BigNumberish,
            BigNumberish,
            BigNumberish,
    ...
    encodeFunctionData(functionFragment: "hashLeftRightBenchmark", values: [BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "hash5Benchmark", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hashLeftRight", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hashLeftRightBenchmark", data: BytesLike): Result;
...
export interface HasherBenchmarks extends BaseContract {
    ...
    getFunction(nameOrSignature: "hash5Benchmark"): TypedContractMethod<[
        array: [
            BigNumberish,
            BigNumberish,
            BigNumberish,
    ...
    getFunction(nameOrSignature: "hashLeftRightBenchmark"): TypedContractMethod<[
        _left: BigNumberish,
        _right: BigNumberish
    ], [
        bigint
...
//# sourceMappingURL=HasherBenchmarks.d.ts.map