...
import type { AccQueueBinary0, AccQueueBinary0Interface } from "../../../contracts/trees/AccQueueBinary0";
type AccQueueBinary0ConstructorParams = [linkLibraryAddresses: AccQueueBinary0LibraryAddresses, signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class AccQueueBinary0__factory extends ContractFactory {
    constructor(...args: AccQueueBinary0ConstructorParams);
    static linkBytecode(linkLibraryAddresses: AccQueueBinary0LibraryAddresses): string;
    ...
    static connect(address: string, runner?: ContractRunner | null): AccQueueBinary0;
}
...
export {};
//# sourceMappingURL=AccQueueBinary0__factory.d.ts.map