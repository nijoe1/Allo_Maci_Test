 ...
 */
export declare enum ProcessMessageErrors {
 ...
 * in Poll.processMessage()
 */
export declare class ProcessMessageError extends Error {
    code: ProcessMessageErrors;
    /**
     * Generate a new instance of the ProcessMessageError class
     * @param code - the error code
     */
    constructor(code: ProcessMessageErrors);
}
